...
// Exact table from ACOM-Controller (no masking; 0xFF = no error). Codes
// not listed here exist - the amp's front panel shows the full text, so
// unknowns render as "see amp display".
const ERROR_TEXT = {
...
class AcomTelemetry {
  ...
  _parseMeasurement(f) {
    ...
    Object.assign(this.state, {
      ...
      errorText: hasError ? (ERROR_TEXT[errorCode] || `Error 0x${errorCode.toString(16)} — see amp display`) : null,
